...
var caCert = crypto.createCACertificate(caSubject, caKeys, 1, true);
...
var serverCert = crypto.createServerCertificate(serverSubject, '127.0.0.1', serverKeys, 2, caCert, caKeys, true);
...
var webidCert = crypto.createWebIDCertificate('test', 'Justus Testus', 'justus.testus@bfh.ch', webidKeys, 3, caCert, caKeys, true).cert;
