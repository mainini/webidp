...
var caCert = pki.createCACertificate(caSubject, caKeys, 1, true);
...
var serverCert = pki.createServerCertificate(serverSubject, '127.0.0.1', serverKeys, 2, caCert, caKeys, true);
...
var webidCert = pki.createWebIDCertificate('test', 'Justus Testus', 'justus.testus@bfh.ch', webidKeys, 3, caCert, caKeys, true).cert;
